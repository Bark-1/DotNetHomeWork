...
namespace OrderManagement
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //3.测试修改订单
            os.ChangeOrder(2, odList3); //修改后：10本，10尺|Karb客户|300元
            try //尝试修改不存在订单
            {
                Console.WriteLine("\nTry change");
                os.ChangeOrder(3, c2);
            ...
            //现在还剩订单1和2
            //4.1按ID查找
            Console.WriteLine(os.FindOrder(1));
            Console.WriteLine(os.FindOrder(2));
            Console.WriteLine(os.FindOrder(3));
            //4.2按商品查找
            Console.WriteLine(os.FindOrder("Book")); //订单1和2都有
            Console.WriteLine(os.FindOrder("Pen"));//订单1有
            Console.WriteLine(os.FindOrder("pen"));//都没有
            //4.3按客户查找
            Console.WriteLine(os.FindOrder(c1));
            Console.WriteLine(os.FindOrder(c2));
            //4.4按价格查找
            Console.WriteLine(os.FindOrder(175.0));
            Console.WriteLine(os.FindOrder(300.0));
            Console.WriteLine(os.FindOrder(100.0));
            //5.排序测试
            //5.1默认排序方式测试：按ID
